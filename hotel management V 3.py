...
if(n==1):
    ...
    Game_no=1
    if money>0:
        print("Your won a total sum of Rupees", money)
    else:
         print("Your lost a total sum of Rupees", money)
         
    e= '''insert into games (guest_no,Game_no,money) values ('%s', '%s', '%s')'''% (guestno,Game_no,money)
    mycursor.execute(e)
    mydb.commit( )
    print("record inserted")  
elif(n==2):
...
if m== 1:
    ...
    while a==1:
        ...
        order=int(input("what do you wish to order"))
        if (order ==1):
            item = "green tea"
            money ='100'
            r=100
            x= "insert into menu (Guest_no,item,money) values ( %s, %s,%s)"
            y= (guestno,item,money)
        ...
        a=int(input("If you wish to order anything else, press 1, else press any other numeric key"))
    

else:
    h=0
    pass
print("Your menu bill is", h)
...
if l== 1:
    ...
    while a==1:
        ...
        order=int(input("what do you wish give for laundry"))
        if (order ==1):
            item = "top"
            money ="100"
            f=int
            f=100
            x= '''insert into laundry values ( '%s', '%s','%s')'''%(guestno,item,money)
            mycursor.execute(x)
            mydb.commit( )
            print("record inserted")
            s=s+f
...
print("We may have also added a mandatory tip")
